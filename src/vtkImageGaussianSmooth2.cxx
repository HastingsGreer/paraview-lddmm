/*=========================================================================
  ...
  Module:    vtkImageGaussianSmooth2.cxx
...
=========================================================================*/
#include "vtkImageGaussianSmooth2.h"
...
vtkStandardNewMacro(vtkImageGaussianSmooth2);

//----------------------------------------------------------------------------
vtkImageGaussianSmooth2::vtkImageGaussianSmooth2()
{
...
//----------------------------------------------------------------------------
void vtkImageGaussianSmooth2::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkImageGaussianSmooth2::ComputeKernel(double *kernel, int min, int max,
                                           double std)
{
  int x;
  double sum;
...
//----------------------------------------------------------------------------
int vtkImageGaussianSmooth2::RequestUpdateExtent (
...
//----------------------------------------------------------------------------
void vtkImageGaussianSmooth2::InternalRequestUpdateExtent(int *inExt,
                                                         int *wholeExtent)
{
  int idx, radius;
...
template <class T>
void
vtkImageGaussianSmooth2Execute(vtkImageGaussianSmooth2 *self, int axis,
...
//----------------------------------------------------------------------------
template <class T>
size_t vtkImageGaussianSmooth2GetTypeSize(T*)
{
  return sizeof(T);
}
...
void vtkImageGaussianSmooth2::ExecuteAxis(int axis,
                                         ...
                                         vtkInformation *inInfo)
{
  ...
  switch (outData->GetScalarType())
    {
    vtkTemplateMacro(
      outIncA *= vtkImageGaussianSmooth2GetTypeSize(static_cast<VTK_TT*>(0))
      );
    default:
  ...
  for (idxA = outExt[axis*2]; idxA <= max; ++idxA)
    ...
    switch (inData->GetScalarType())
      {
      vtkTemplateMacro(
        vtkImageGaussianSmooth2Execute(this, axis, kernel, kernelSize,
...
void vtkImageGaussianSmooth2::ThreadedRequestData(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector,
  vtkImageData ***inData,
